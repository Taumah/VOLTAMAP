...
our %config = (
  ...
  CPPINCLUDES => [  ],
  CXX => "/home/maathess/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a",
  CXXFLAGS => [ "-target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/home/maathess/Bureau/VOLTAMAP/src/main/app/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/libs_collections/voltamap/arm64-v8a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
