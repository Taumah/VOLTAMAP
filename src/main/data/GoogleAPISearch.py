...
class GoogleAPISearch:
    ...
    def getNearbyStation(self):
        url = self.base_url + "/nearbysearch/json?location=48.97472824016118%2C2.0494848456340353&radius=5000" \
                              "&keyword=charging electric vehicule station&key=" + self.key
